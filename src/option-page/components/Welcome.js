  ...
  const SnackBarMessage = (
    <div>
      <h4 style={{ fontSize: "1.2rem" }}>
        {" "}
        <a
          href={Constants.support.proVersionLink}
        ...
        <ul>
          Features:
          <li> - Multiple Languages OCR.</li>
          <li> - Best quality Image to Text (OCR).</li>
          <li> - Available free of Cost.</li>
        </ul>
      </h4>
    </div>
  );
          ...
          <div className="w-full flex items-center justify-between">
            ...
            <div className="flex w-1/2 justify-end content-center">
              <a
                ...
                href="https://github.com/fxnoob/image-to-text"
              >
                <svg
        ...
        <div className="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          ...
          <div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
            <h1
              ...
              style={{ color: "var(--main-color)" }}
            >
              Extract text from any page/file on the internet
            </h1>
