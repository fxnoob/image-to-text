  ...
  return (function(e) {
          ...
          S = function(e) {
            ...
            return new Promise(function(e, i) {
              l(
                ...
                E(n, e),
                k(n, i),
                w(O, { workerId: t, jobId: r, action: n, payload: o });
            });
          },
          L = (function() {
            var e = o(
                ...
                return regeneratorRuntime.wrap(function(e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (e.t0 = S), (e.t1 = f), (e.t2 = r), (e.next = 5), b(t)
                        );
                      case 5:
                        return (
                          (e.t3 = e.sent),
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        ...
                        return (
                          (e.next = 3), S(f({ id: t, action: "terminate" }))
                        );
                      case 3:
                        g(O), (O = null);
                      case 5:
        ...
        return (
          v(O, function(e) {
            var t = e.workerId,
              ...
              c = e.data;
            if ("resolve" === o) {
              l("[".concat(t, "]: Complete ").concat(r));
              var u = c;
              "recognize" === a
                ? (u = s(c))
                : "getPDF" === a &&
                  (u = Array.from(i({}, c, { length: Object.keys(c).length }))),
                h[a]({ jobId: r, data: u });
            } else {
              if ("reject" === o) throw (j[a](c), Error(c));
              "progress" === o && n(c);
            }
          }),
          {
            ...
            setReject: k,
            load: function(e) {
              return S(f({ id: e, action: "load", payload: { options: a } }));
            },
    ...
    function(e, t, r) {
      ...
      e.exports = (function(e) {
        ...
        { OEM: c, PSM: u, createScheduler: o, createWorker: i, setLogging: s },
        a
      );
    },
    function(e, t, r) {
      (function(e) {
        ...
        var r = (function(e) {
          ...
          var j = (v.prototype = y.prototype = Object.create(b));
          function O(e) {
          ...
          return (
            (g.prototype = j.constructor = v),
            (v.constructor = g),
            (v[u] = g.displayName = "GeneratorFunction"),
              ...
              t.lines.forEach(function(n) {
                n.words.forEach(function(o) {
                  o.symbols.forEach(function(i) {
                    ...
                    i.push(
                      r({}, o, { page: e, block: c, paragraph: t, line: n })
                    );
                }),
                  o.push(r({}, n, { page: e, block: c, paragraph: t }));
              }),
                n.push(r({}, t, { page: e, block: c }));
            }),
              t.push(r({}, c, { page: e }));
          }),
          r({}, e, { blocks: t, paragraphs: n, lines: o, words: i, symbols: a })
        );
      };
    },
    function(e, t, r) {
    ...
    function(e) {
      e.exports = {
        ...
        scripts: {
          ...
          build:
            "rimraf dist && webpack --config scripts/webpack.config.prod.js",
          prepublishOnly: "npm run build",
          wait:
            "rimraf dist && wait-on http://localhost:3000/dist/tesseract.dev.js",
          test: "npm-run-all -p -r start test:all",
          "test:all": "npm-run-all wait test:browser:* test:node:all",
          "test:node":
            "nyc mocha --exit --bail --require ./scripts/test-helper.js",
          "test:node:all": "npm run test:node -- ./tests/*.test.js",
          "test:browser-tpl":
            "mocha-headless-chrome -a incognito -a no-sandbox -a disable-setuid-sandbox -a disable-logging -t 300000",
          "test:browser:detect":
            "npm run test:browser-tpl -- -f ./tests/detect.test.html",
          "test:browser:recognize":
            "npm run test:browser-tpl -- -f ./tests/recognize.test.html",
          "test:browser:scheduler":
            "npm run test:browser-tpl -- -f ./tests/scheduler.test.html",
          lint: "eslint src",
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 8:
                      return (
                        (e.next = 10),
                        i.get(a(t), { responseType: "arraybuffer" })
                      );
                    case 10:
                      (n = e.sent), (s = n.data), (r = s);
                    case 13:
                      e.next = 33;
                      break;
                    case 15:
    ...
    function(e, t, r) {
      ...
      (o.prototype = new Error()),
        ...
        (e.exports = function(e) {
          for (
            var t, r, i = String(e), a = "", c = 0, u = n;
            i.charAt(0 | c) || ((u = "="), c % 1);
            a += u.charAt(63 & (t >> (8 - (c % 1) * 8)))
          ) {
